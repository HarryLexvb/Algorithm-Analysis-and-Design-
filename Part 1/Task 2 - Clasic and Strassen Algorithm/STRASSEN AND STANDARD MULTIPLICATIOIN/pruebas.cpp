...
void strassen_algorithm(int** A, int** B, int** C, int N){
    if (N == 1)
        *(*(C + 0) + 0 ) =  *(*(A + 0) + 0 ) *  *(*(B + 0) + 0);
        ...
        strassen_algorithm(temp1, temp2, m1, (N / 2)); //m1 = (a11 + a22) (b11 + b22)

        matrix_sum(a21, a22, temp1, (N / 2)); // a21 + a22
        strassen_algorithm(temp1, b11, m2, (N / 2)); //m2 = (a21 + a22) b11

        matrix_sub(b12, b22, temp1, (N / 2)); // b12 - b22
        strassen_algorithm(a11, temp1, m3, (N / 2)); //m3 = a11 (b12 - b22)

        matrix_sub(b21, b11, temp1, (N / 2)); // b21 - b11
        strassen_algorithm(a22, temp1, m4, (N / 2)); //m4 = a22 (b21 - b11)

        matrix_sum(a11, a12, temp1, (N / 2)); // a11 + a12
        strassen_algorithm(temp1, b22, m5, (N / 2)); //m5 = (a11 + a12) b22

        matrix_sub(a21, a11, temp1, (N / 2)); // a21 - a11
        matrix_sum(b11, b12, temp2, (N / 2)); // b11 + b12
        strassen_algorithm(temp1, temp2, m6, (N / 2)); //m6 = (a21 - a11) (b11 + b12)

        matrix_sub(a12, a22, temp1, (N / 2)); // a12 - a22
        matrix_sum(b21, b22, temp2, (N / 2)); // b21 + b22
        strassen_algorithm(temp1, temp2, m7, (N / 2)); //m7 = (a12 - a22) (b21 + b22)
...
int main(){
    ...
    ofstream result;
    result.open("C:/Users/win 10/Documents/SUBLIME/result.txt");
    if(!result.is_open()){
        cout << "Error" << endl;
        return 1;
    } 
